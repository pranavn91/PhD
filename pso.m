...
CostFunction=@(m) ClusteringCost(m, X);     % Cost Function is a function of m which returns ClusteringCost(m,X)
...
for it=1:MaxIt
    ...
    % Plot Solution
    figure(1);
    finalanswer = PlotSolution(X, BestSol);
    pause(0.01);
...
csvwrite('psom-mydata-results.csv', finalanswer);
