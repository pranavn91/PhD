...
CostFunction=@(m) BetaCV(m, X, k);     % Cost Function is a function of m which returns ClusteringCost(m,X)
...
%csvwrite('psobeta-ecoli-results.csv', finalanswer);
 %csvwrite('psobeta-iris-results.csv', finalanswer); 
 %csvwrite('psobeta-wine-results.csv', finalanswer);
%csvwrite('psobeta-wisc-results.csv', finalanswer);
 csvwrite('psobeta-yeast-results.csv', finalanswer);
